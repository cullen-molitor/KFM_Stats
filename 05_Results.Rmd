...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme() 
Simp_Diversity_Plot <-ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
```{r RF PDP 2, fig.height=8.5, fig.width=7.5}
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Parpar_Density_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Parpar, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("1993-01-01")), size = 1) +
  geom_label(aes(x = as.Date("1993-01-01"), y = Inf, vjust = 1,
...
p2 <- ggplot2::ggplot() +
  ...
  scale_fill_gradient2(high = "darkred", mid = "white", low = "navyblue", midpoint = 0,
                       guide = guide_colorbar(direction = "horizontal", title.position = "top",
                                              order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Parpar, size = 1,
              aes(x = Date, y = Mean_Density, color = IslandName)) +
  geom_vline(aes(xintercept = as.Date("1993-01-01")), size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01"), ymin = 0, ymax = Inf), size = 1) +
  geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
  ggplot2::scale_y_continuous(expand = expansion(mult = c(.1, 0)),
                              limits = c(0, NA), oob = squish) +
...
Parpar_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Parpar_Orig16_annotated <- ggpubr::annotate_figure(
  Parpar_Orig16_Plot,
  left = text_grob("Parastichopus parvimensis density (#/m²)", 
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Kelletia_kelletii_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
Kelletia_kelletii_Biomass_annotated <- ggpubr::annotate_figure(
  Kelletia_kelletii_Biomass_Plot,
  left = text_grob(paste("Kelletia kelletii Biomass (g/m²)"), 
                   color = "black", rot = 90, size = 12))
...
p1 <- ggplot(Kelkel, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  scale_fill_gradient2(high = "darkred", mid = "white", low = "navyblue", midpoint = 0,
                       guide = guide_colorbar(direction = "horizontal", title.position = "top",
                                              order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Kelkel, size = 1,
...
Kelkel_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Kelkel_Orig16_annotated <- ggpubr::annotate_figure(
  Kelkel_Orig16_Plot,
  left = text_grob("Kelletia kelletii biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Palint_Density_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Loby, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  scale_fill_gradient2(high = "darkred", mid = "white", low = "navyblue", midpoint = 0,
                       guide = guide_colorbar(direction = "horizontal", title.position = "top",
                                              order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Loby, size = 1,
              aes(x = Date, y = Mean_Density, color = IslandName)) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
...
Loby_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Loby_Orig16_annotated <- ggpubr::annotate_figure(
  Loby_Orig16_Plot,
  left = text_grob("Panulirus interruptus density (#/m²)",
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Hyprub_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
`r Hypsy_fig` Garibaldi (*Hypsypops rubicundus*) biomass by reserve status across all reference sites (top), biomass by island across all reference sites (Middle), and FSC by island and reserve status across all reference sites (Bottom); gray intervals indicate 95% confidence ranges with LOESS smoothing. Oceanic Niño Index (ONI) is a measure of ENSO strength, in units of °C.

```{r Garibaldi original 16 sites, warning=FALSE, message=FALSE, fig.height=6, fig.width=10}
Gari <- Original_16_VFT_Data %>% 
  dplyr::filter(CommonName == "garibaldi") %>%
  dplyr::mutate(IslandName = gsub(" Island", "", IslandName)) %>%
  dplyr::mutate(IslandName = factor(IslandName, levels= IslandLevels)) %>%
  dplyr::mutate(Date = base::as.Date(base::ISOdate(SurveyYear, 1, 1)))

p1 <- ggplot(Gari, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Gari_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Gari_Orig16_annotated <- ggpubr::annotate_figure(
  Gari_Orig16_Plot,
  left = text_grob("Garibaldi density (#/m³)",
                   color = "black", rot = 90, size = 12))
...
```{r Cystoseira cover Plots, fig.width=7.5, warning=FALSE, message=FALSE, fig.height=10}
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
cysto_cover_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
`r Cysto_fig` *Cystoseira* sp. (bladderchain kelp) density by reserve status across all reference sites (top), by island across all reference sites (middle), and by island and reserve status across all reference sites (bottom); gray intervals indicate 95% confidence ranges with LOESS smoothing. Oceanic Niño Index (ONI) is a measure of ENSO strength, in units of °C.
...
p1 <- ggplot(Gari, aes(x = Date, y = Percent_Cover, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Gari_Orig16_annotated <- ggpubr::annotate_figure(
  Gari_Orig16_Plot,
  left = text_grob("Cystoseira sp. density (#/m²)",
                   color = "black", rot = 90, size = 12))
print(Gari_Orig16_annotated)
```
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Tetaur_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Tetaur, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
...
Tetaur_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8,1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
RedUrchin_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Strfra, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) +
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Strfra_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Patmin_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Patmin, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Patmin_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Kelp_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Macro, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  scale_fill_gradient2(high = "darkred", mid = "white", low = "navyblue", midpoint = 0,
                       guide = guide_colorbar(direction = "horizontal", title.position = "top",
                                              order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Macro, size = 1,
              aes(x = Date, y = Mean_Biomass, color = IslandName)) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
...
Macro_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
PurpleUrchin_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Lytana, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Lytana_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p1 <- ggplot(Strpur, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Strpur_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Sempul_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(SheepM, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  scale_fill_gradient2(high = "darkred", mid = "white", low = "navyblue", midpoint = 0,
                       guide = guide_colorbar(direction = "horizontal", title.position = "top",
                                              order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = SheepM, size = 1, 
                       aes(x = Date, y = Mean_Density, color = IslandName)) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
...
SheepM_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
parclat_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(KelpBass, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  scale_fill_gradient2(high = "darkred", mid = "white", low = "navyblue", midpoint = 0,
                       guide = guide_colorbar(direction = "horizontal", title.position = "top",
                                              order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = KelpBass, size = 1, 
                       aes(x = Date, y = Mean_Density, color = IslandName)) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
...
KelpBass_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Halsem_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(rwf, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
rwf_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p1 <- ggplot(rwm, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
rwm_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Pychel_Biomass_Plot <- ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot(Pychel, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  geom_smooth(size = 1) +
  geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
Pychel_Orig16_Plot <- ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
...
ggplot2::ggplot(Benthic_Biomass_Long, aes(x = SurveyYear, y = Mean_Biomass, fill = ScientificName)) +
  ...
  ggplot2::labs(title = NULL, x = "Survey Year", y = "Biomass (g/m²)",
                fill = "Scientific Name") +
  Biomass_Summary_theme()
```

`r BenBio_fig` Benthic biomass summary plot. 
...
`r FishBio_all_fig` Biomass of `r length(unique(Fish_Biomass_Long$ScientificName))` species of fish. 
