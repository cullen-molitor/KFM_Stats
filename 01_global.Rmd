...
```{r Themes and Functions, include = FALSE}
...
```{r Useful Vectors, include = FALSE}
...
```{r Figures and Tables, include = FALSE}
{ # Figures and Tables   ----
